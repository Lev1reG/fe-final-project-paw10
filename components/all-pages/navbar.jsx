...
const NavBar = () => {
  ...
  return (
    <>
      {/* Navbar */}
      <nav className="fixed w-full bg-secondary px-8 py-4 flex justify-between items-center shadow-md">
        {/* Nama Kelompok */}
        <div className="text-xl font-bold text-black">Kelompok 10</div>
